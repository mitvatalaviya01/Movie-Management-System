...
void collection_sort()
{
   ...
   for(int i=0;i<c;i++)
   {
    for(int j=0;j<c;j++)
    {
       ...
       printf("\nNumber\tMovie_name\tType\tActor_name\tActress_name\tHit_song\tCollection\tBudget\t\tReleaseyear\tDirector_name\tRating");
   for(i=0;i<c;i++)
   {
